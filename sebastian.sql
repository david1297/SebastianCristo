...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 05-12-2019 a las 16:46:05
...
INSERT INTO `citas` (`Numero`, `Fecha`, `Hora`, `Cliente`, `Usuario`, `Descripcion`, `Direccion`, `Estado`) VALUES
(1, '2019-12-15', '08:30:00', '123456789', '123456789', 'Cita', 'Ddd', 'Programado'),
(2, '2019-12-16', '08:30:00', '123456789', '123456789', 'Cita', 'Ddd', 'Programado');
...
INSERT INTO `clientes` (`Documento`, `Tipo_Documento`, `Tipo_Persona`, `Nombre`, `Telefono`, `Correo`, `FechaCreacion`, `Estado`, `Ciudad`, `Direccion`) VALUES
('123456789', 'Cedula', 'Natural', 'ejemplo ', '36925814', 'ejemplo@gmail.com', '2019-12-02', 'Activo', 1096, 'ddd'),
('321654', 'Cedula', 'Natural', 'el bromas', '032164', 'Ejemplo@gmail.com', '2019-12-02', 'Activo', 138, 'carrera 95 # 2b 13'),
('987654321', 'Cedula', 'Natural', 'Pepito', '3230', 'hio', '2019-12-02', 'Activo', 1096, 'ffff');
...
INSERT INTO `usuarios` (`Identificacion`, `Tipo_Documento`, `Primer_Nombre`, `Segundo_Nombre`, `Primer_Apellido`, `Segundo_Apellido`, `Nombre_Completo`, `Telefono`, `Direccion`, `Correo`, `Celular`, `Rol`, `Clave`, `Estado`) VALUES
('1112492933', 'Cedula', 'Juan', '', 'Andrade', '', 'Juan David Andrade Valencia', '4852040', 'Carrera 95 #2b-21', 'juandavid.andrade1997@gmail.com', '3004885454', 1, '$2y$10$QTAFO8CodSKEVi94BbHsyed1r/rC4RxTd8PVhhdHZwb9kLAETB.rS', 'Activo'),
('123456789', 'Cedula', 'Vendero', '', '1', '', 'Vendedor 1', '963852741', '0000', 'Vetnas1@gmail.com', '123456', 3, '$2y$10$QTAFO8CodSKEVi94BbHsyed1r/rC4RxTd8PVhhdHZwb9kLAETB.rS', 'Activo');
...
--
ALTER TABLE `ciudades`
  MODIFY `Codigo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1128;
