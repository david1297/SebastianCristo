...
<div class="table-responsive">
  <table class="table table-hover" width="100%" cellspacing="0">
    ...
    <?php
			$sql="select CotizacionDT.Id,CotizacionDT.Producto,CotizacionDT.Valor,Productos.Nombre from CotizacionDT 
            inner join Productos on Productos.Codigo=CotizacionDT.Producto where CotizacionDT.Cotizacion= $Numero and CotizacionDT.Cliente ='$Cliente' ";
