...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary" style='float: left !important;'>Ventas</h6>
        <div class="btn-group" style='float: right !important;'>
		    <button type="button" class="btn btn-danger" onclick="NuevaVenta()">
				<span class="fas fa-user-tie"></span> Nueva Venta
			</button>
		</div>
  </div>
  <div class="card-body">
