...
INSERT INTO `citas` VALUES (1,'2019-12-15','08:30:00','1234','1112492933','Cita','Ddd','Programada','2019-12-15','','123456789'),(2,'2019-12-16','14:30:00','1234','1112492933','Cita redes sociales','Ddd','Realizada','2019-12-16','','123456789'),(3,'2019-12-09','10:00:00','321654','1112492933','Cita para consulta de Marketing','carrera 95 # 2b 13','Programada','2019-12-06','','123456789'),(4,'2019-12-09','19:00:00','1234','1112492933','fddff','jom','Programada','2019-12-09','','123456789');
...
INSERT INTO `Cotizacion` VALUES (1,'2019-12-09','1234','1112492933',7,1700000,'Aprobada'),(2,'2019-12-09','987654321','1112492933',8,1700000,'Aprobada');
/*!40000 ALTER TABLE `Cotizacion` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `CotizacionD`
--
...
LOCK TABLES `CotizacionD` WRITE;
/*!40000 ALTER TABLE `CotizacionD` DISABLE KEYS */;
INSERT INTO `CotizacionD` VALUES (55,1,'1',1000000),(56,1,'2',700000),(83,2,'2',700000),(84,2,'1',1000000);
/*!40000 ALTER TABLE `CotizacionD` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `CotizacionDT`
--

DROP TABLE IF EXISTS `CotizacionDT`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `CotizacionDT` (
  `Id` int(11) NOT NULL AUTO_INCREMENT,
  `Cliente` varchar(50) DEFAULT NULL,
  `Cotizacion` int(11) DEFAULT NULL,
  `Producto` varchar(30) DEFAULT NULL,
  `Valor` double DEFAULT NULL,
  PRIMARY KEY (`Id`)
) ENGINE=InnoDB AUTO_INCREMENT=1461 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `CotizacionDT`
--

LOCK TABLES `CotizacionDT` WRITE;
/*!40000 ALTER TABLE `CotizacionDT` DISABLE KEYS */;
INSERT INTO `CotizacionDT` VALUES (1417,'1234',1,'1',1000000),(1418,'1234',1,'2',700000),(1459,'987654321',2,'2',700000),(1460,'987654321',2,'1',1000000);
/*!40000 ALTER TABLE `CotizacionDT` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `Ventas` VALUES (1,'2019-12-09','1234','1112492933',1,1700000,'Pendiente'),(2,'2019-12-09','123456789','1112492933',1,700000,'Programada'),(3,'2019-12-09','1234','1112492933',1,700000,'Pendiente'),(4,'2019-12-09','987654321','1112492933',1,1000000,'Programada'),(5,'2019-12-09','987654321','1112492933',1,1000000,'Programada'),(6,'2019-12-09','1234','1112492933',1,1700000,'Pendiente'),(7,'2019-12-09','1234','1112492933',1,1700000,'Aprobada'),(8,'2019-12-09','987654321','1112492933',1,1700000,'Aprobada');
...
INSERT INTO `VentasD` VALUES (12,2,'2',700000),(14,4,'1',1000000),(15,5,'1',1000000),(18,6,'1',1000000),(19,6,'2',700000),(20,3,'2',700000),(21,1,'2',700000),(22,1,'1',1000000),(23,7,'1',1000000),(24,7,'2',700000),(25,8,'2',700000),(26,8,'1',1000000);
...
INSERT INTO `VentasDT` VALUES (6,'321654',0,'1',1000000),(20,'1234',2,'2',700000),(24,'1234',4,'1',1000000),(37,'987654321',4,'1',1000000),(42,'123456789',2,'2',700000),(44,'987654321',5,'1',1000000),(55,'1234',6,'1',1000000),(61,'1234',3,'2',700000),(71,'',0,'1',1000000),(90,'1234',1,'2',700000),(91,'1234',1,'1',1000000),(92,'1234',7,'1',1000000),(93,'1234',7,'2',700000),(98,'987654321',8,'2',700000),(99,'987654321',8,'1',1000000);
...
-- Dump completed on 2019-12-09 16:04:11
