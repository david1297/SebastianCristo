...
<div class="card shadow mb-4">
  <div class="card-header py-3">
    <h6 class="m-0 font-weight-bold text-primary" style='float: left !important;'>Cotizaciones</h6>
        <div class="btn-group" style='float: right !important;'>
		    <button type="button" class="btn btn-danger" onclick="NuevaCotizacion()">
				<span class="fas fa-user-tie"></span> Nueva Cotizacion
			</button>
		</div>
  </div>
  <div class="card-body">
